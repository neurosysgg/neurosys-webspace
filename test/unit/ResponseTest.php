...
final class ResponseTest extends TestCase
{
    ...
    /** nav.js swaps this straight into #content, so a full document here would nest one. */
    ...
    /**
     * nav.js HTML-decodes this before assigning document.title. The two have to agree:
