...
final class ApiTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sandbox = sys_get_temp_dir() . '/neurosys-api-' . bin2hex(random_bytes(6));
    ...
    /**
     * Every method this site recognises, plus one it does not.
     *
    ...
    /**
     * A route with no declared policy is read-only, which is nine of the ten.
     *
     * @return void
     */
    ...
    /**
     * A delegated route accepts even a method this site does not recognise.
     *
    ...
    public function testTheVersionActionReportsWhatIsDeployed(): void
    {
        ...
        self::assertStringContainsString(\NeuroSYS\AssetManifest::SCRIPT, $body);
