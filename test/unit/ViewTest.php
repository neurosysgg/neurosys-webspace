...
final class ViewTest extends TestCase
{
    ...
    {
        foreach (AssetManifest::MODULES as $module) {
            self::assertNotSame(Site::SCRIPT, self::withoutVersion($module));
        }

        self::assertStringNotContainsString(
            '<link rel="modulepreload" href="' . Site::SCRIPT,
     ...
     * output, and {@link Site} declares the same two paths in PHP — a mirror, and so pinned like
    ...
    {
        self::assertSame(Site::STYLESHEET, self::withoutVersion(AssetManifest::STYLESHEET));
        self::assertSame(Site::SCRIPT, self::withoutVersion(AssetManifest::SCRIPT));
    }
