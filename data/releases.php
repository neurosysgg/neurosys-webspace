...
return [
    'ill' => new Release(
        ...
        Genre::Dubstep,
        'second single',
        '<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay; encrypted-media" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/soundcloud%3Atracks%3A2394077313%3Fsecret_token%3Ds-dIMAqki109G&color=%239e55e6&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/neurosysgg" title="neuro.SYS" target="_blank" style="color: #cccccc; text-decoration: none;">neuro.SYS</a> · <a href="https://soundcloud.com/neurosysgg/ill/s-dIMAqki109G" title="ill." target="_blank" style="color: #cccccc; text-decoration: none;">ill.</a></div>',
        'https://my.hidrive.com/api/sharelink/download?id=J2FXbB70A',
        new Collection(Format::class)->add(
            new Format(ReleaseFormat::FLAC, 'https://my.hidrive.com/api/sharelink/download?id=BXRsy9S7d'),
            new Format(ReleaseFormat::WAV, 'https://my.hidrive.com/api/sharelink/download?id=RVg8LBS4A'),
            new Format(ReleaseFormat::MP3, 'https://my.hidrive.com/api/sharelink/download?id=CPJy7AVIu'),
            new Format(ReleaseFormat::STEMS, 'https://my.hidrive.com/api/sharelink/download?id=D2PUDjoII'),
        )
    ),
