...
clover XML and a browsable HTML report. **99.56% of lines** (3380/3395), derived on 2026-09-13
(with typed input, on top of `6619066`). This is the one place the figure is written: CLAUDE.md points here rather than
