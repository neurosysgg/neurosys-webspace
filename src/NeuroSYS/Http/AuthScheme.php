 ...
 * reaches {@link self::NS1} the same way — see {@link \NeuroSYS\Service\ApiGate}.
 */
enum AuthScheme: string
{
     ...
     *
     * Its parameters are one opaque base64 token — {@link \NeuroSYS\Model\Api\ApiCredential}'s
     ...
     * {@link \NeuroSYS\Service\ApiGate}, has to refuse both and should not have to know they
