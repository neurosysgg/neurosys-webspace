 ...
 * {@link \NeuroSYS\View\Html\LinkTarget} — it exists to make the segment a type, not to offer a
 ...
 *
 * **It is deliberately not the credential's version.** {@link \NeuroSYS\Http\AuthScheme::NS1}
