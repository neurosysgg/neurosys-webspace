 ...
 *
 * It is {@link \NeuroSYS\Controller\Controller} one layer in, and the difference is what has
 ...
 * {@link \NeuroSYS\Service\ApiGate} has proved the caller holds the private key. So it takes no
 ...
 * from its {@link \NeuroSYS\Model\Api\VerifiedRequest} by
...
interface ApiHandler
{
     ...
     * neither {@link \NeuroSYS\Controller\Controller::handle()} nor
     * {@link \NeuroSYS\Http\Response::send()} carries one either. Every carrier under `src/` is a
     * concrete builder or a gate's decision — see {@link \NeuroSYS\Service\ApiGate::accepts()},
     * which is one.
     *
     * @return Response
     */
