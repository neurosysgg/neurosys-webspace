...
enum ApiService: string
{
     ...
     *
     * Verdicts only, against the floors {@link \NeuroSYS\Support\RequirementInitialization}
     ...
     * which runs a developer's PHP. See {@link \NeuroSYS\Service\Api\HealthCheck}.
     *
