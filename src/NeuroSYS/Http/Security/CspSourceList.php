 ...
 * {@link \NeuroSYS\Support\SearchableCollection} has to be told what its *values* are. Told
 ...
 *
 * **It is also what falls out of {@link \NeuroSYS\Support\TypedItems::SCALARS} refusing `array`.**
