 ...
 * header is nothing like another's. So the framework asks {@link \NeuroSYS\App::shell()} for this
 * and hands it each view whole, and {@link \NeuroSYS\Http\ViewResponse} never knows what the page
