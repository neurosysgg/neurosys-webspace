...
enum MetaName: string
{
     ...
     *
     * Paired with `width=device-width, initial-scale=1.0`, which is content rather than a name and
     * so stays a string: it is a descriptor list with its own grammar, not a case.
     */
