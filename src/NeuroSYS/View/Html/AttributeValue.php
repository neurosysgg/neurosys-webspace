 ...
 * {@link \NeuroSYS\Http\HeaderValue} did on the other side of the site: the name was typed first
 ...
 * with parts.
 *
 * `render()` rather than `__toString()`, exactly as {@link \NeuroSYS\Http\HeaderValue} reasons: it
