...
class Layout
{
     ...
     * script, so this cannot quietly describe a graph that has moved on. Each href carries the `?v=`
     * the module's own specifier carries — they come from the same stamp in the same pass, which is
     * the point of one tool owning both. A hint whose query differed from the resolved specifier
     * would be a different URL, so the browser would fetch the file twice and the hint would be
     * worse than nothing.
     *
