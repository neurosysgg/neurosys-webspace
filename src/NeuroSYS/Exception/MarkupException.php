 ...
 *
 * - {@link ElementException} — {@link \NeuroSYS\View\Html\Element} refusing to be something no
 *   element can be: a void element with children, a URL naming a scheme the site does not emit.
 * - {@link ParserException} — {@link \NeuroSYS\View\Html\MarkupParser} refusing markup that names an
