 ...
 *   {@link \NeuroSYS\View\Html\MarkupParser} needs — it refuses a policy document on any parse
...
final readonly class Diagnostics
{
     ...
     * {@link \NeuroSYS\View\Html\MarkupParser::read()}, where `Dom\HTMLDocument` reports every
