 ...
 * {@link \NeuroSYS\Service\Auth} is what compares against it — so it belongs to neither
 * `Model/` nor `Service/`.
 *
...
final readonly class PasswordHash
{
     ...
     * null and refuses, which is what {@link \NeuroSYS\Service\Auth::accepts()} already did in its
