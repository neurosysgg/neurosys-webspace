 ...
 * routes out of ten. It is wrong for {@link SitePath::Update}, whose entire purpose is to be
 * indistinguishable from an address that does not exist: `PUT /update` would then answer
...
enum MethodPolicy: string
{
     ...
     * {@link \NeuroSYS\Controller\UpdateController} does by handing anything it will not verify to
     * {@link \NeuroSYS\Controller\UnroutedController} — the same object the router uses for a path
     ...
     *
     * Takes a nullable method because {@link \NeuroSYS\Http\Request::method()} is nullable: an
     ...
     * router answering differently for `BREW /update` than for `BREW /no-such-page`.
     *
