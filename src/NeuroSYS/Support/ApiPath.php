 ...
 * this address whether or not it links to it. {@link \NeuroSYS\App::routeTable()} appends it to
...
enum ApiPath: string implements Path
{
     ...
     * {@link \NeuroSYS\Http\Api\ApiService} case and its handlers, with no route to register and
