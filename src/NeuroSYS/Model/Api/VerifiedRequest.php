...
/**
 * The VerifiedRequest class. What {@link \NeuroSYS\Service\ApiGate} proved, and what it proved it
 * about.
 *
 ...
 * signature passed, which is why {@link \NeuroSYS\Http\Api\ApiHandler} takes no `Request` and can
