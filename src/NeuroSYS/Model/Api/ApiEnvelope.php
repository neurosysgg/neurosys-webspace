 ...
 *   accepted. See {@link \NeuroSYS\Service\ApiGate}.
 *
 * **What `path` binds is {@link \NeuroSYS\Http\Request::path()}'s output, not the wire target**, and
 ...
 * therefore *not* the inverse of {@link \NeuroSYS\Support\Route::matches()}: a capture of `%70atch`
 ...
 * argument is {@link \NeuroSYS\Model\Update\UpdateManifest}'s and applies twice over here, since
...
final readonly class ApiEnvelope
{
     ...
     * @param string $method The method this credential was minted for, as {@link \NeuroSYS\Http\HttpMethod}
