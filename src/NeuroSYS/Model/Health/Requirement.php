 ...
 * own deployment checks are written that way ({@link \NeuroSYS\Service\Health\WebrootRequirement},
 * {@link \NeuroSYS\Service\Health\DataFileRequirement}), so the extension point has been used by
 * the code that defines it rather than only described. Declarations live in
 * {@link \NeuroSYS\Support\RequirementInitialization}; see `docs/health.md`.
 *
