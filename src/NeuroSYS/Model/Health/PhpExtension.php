...
enum PhpExtension: string
{
     ...
     * {@link \NeuroSYS\View\Html\Element::staysOnThisOrigin()} resolves an attribute's URL the way
     * a browser would, and {@link \NeuroSYS\Http\Request::path()} reads the request target with
    ...
    /**
     * What unpacks a pushed payload, in one call in {@link \NeuroSYS\Service\UpdateApplier}.
     *
