 ...
 * built from parts. {@link \Phpanta\View\Html\Element} would refuse a `javascript:` URL at
...
final readonly class Profile
{
     ...
     *
     * Stricter than what {@link \Phpanta\View\Html\Element} allows an `href` in general, because
